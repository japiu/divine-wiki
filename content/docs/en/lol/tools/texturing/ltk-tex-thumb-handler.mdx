...
It does the same job as [Tex Thumbnail Provider](/docs/lol/tools/texturing/tex-thumbnail-provider)
by RitoShark. Pick one, not both.
...
Pick the RitoShark version if you want a per-user install with no admin rights.
...
[Tex Thumbnail Provider page](/docs/lol/tools/texturing/tex-thumbnail-provider)
for its install and removal steps.
