...
<Callout type="info" title="Use Jade instead for most edits">
  ...
  `.bin` files visually with syntax coloring, hover previews, and live
  hash lookups. No converting back and forth. Pick Ritobin only if you
  need batch scripts or you're already comfortable with the text workflow.
</Callout>
